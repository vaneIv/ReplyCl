...
import com.vane.android.replycl.util.lerpArgb
import com.vane.android.replycl.util.themeColor
import com.vane.android.replycl.util.themeInterpolator
...
class EmailSwipeActionDrawable(context: Context) : Drawable() {
    ...
    // React to represent the circle used for the background/circular reveal animation.
    ...
    private fun update() {
        ...
        val slideToIconCenter = iconMargin + (iconIntrinsicWidth / 2F)
        ...
        // corner of the rect.
        cr = hypot(circle.right - slideToIconCenter, (circle.height() / 2F))
